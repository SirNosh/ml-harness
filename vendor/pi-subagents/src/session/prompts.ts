...
- Do not read orchestration workflow files under chains/; those are reserved for the parent orchestrator
- Read only files explicitly named in the task prompt, including any named .ml-harness/reports/{part-id}.md files, or artifacts directly produced by your task
- Treat .ml-harness/truths/project-context.md, .ml-harness/truths/phase-breakdown.md, and .ml-harness/state.json as restricted broad context unless the task prompt explicitly names them
- If required context is missing, say which file or artifact you need instead of exploring broadly
