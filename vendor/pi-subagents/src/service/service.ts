 ...
 *
 *   const { getSubagentsService } = await import("@nosh/pi-subagents");
...
export interface SubagentsService {
  ...
  /**
   * Register an extra directory of agent markdown files supplied by another
   * package or extension. Returns a disposer that unregisters the directory.
   */
  registerAgentDirectory(dir: string): () => void;
...
const SERVICE_KEY = Symbol.for("@nosh/pi-subagents:service");
